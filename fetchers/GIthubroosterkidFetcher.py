...
import requests
class GIthubroosterkidFetcher(BaseFetcher):
    """
    ...
    def fetch(self):
        ...
        urls = {
            "socks5": "https://raw.githubusercontent.com/roosterkid/openproxylist/master/SOCKS5_RAW.txt",
            "https": "https://raw.githubusercontent.com/roosterkid/openproxylist/master/HTTPS_RAW.txt",
        }
        proxies = []
