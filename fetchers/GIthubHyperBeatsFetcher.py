...
import requests
class GIthubHyperBeatsFetcher(BaseFetcher):
    """
    ...
    def fetch(self):
        ...
        urls = {
            "socks5": "https://raw.githubusercontent.com/HyperBeats/proxy-list/master/socks5.txt",
            "http": "https://raw.githubusercontent.com/HyperBeats/proxy-list/master/http.txt",
            "https": "https://raw.githubusercontent.com/HyperBeats/proxy-list/master/https.txt"
        }
        proxies = []
