...
import requests
class GIthubprxchkFetcher(BaseFetcher):
    """
    ...
    def fetch(self):
        ...
        urls = {
            "socks5": "https://raw.githubusercontent.com/prxchk/proxy-list/master/socks5.txt",
            "http": "https://raw.githubusercontent.com/prxchk/proxy-list/master/http.txt",
        }
        proxies = []
