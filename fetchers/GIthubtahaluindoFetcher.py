...
import requests
class GIthubtahaluindoFetcher(BaseFetcher):
    """
    https://github.com/tahaluindo/Free-Proxies
    """
    ...
    def fetch(self):
        ...
        urls = {
            "http": "https://raw.githubusercontent.com/tahaluindo/Free-Proxies/master/proxies/http.txt",
        }
        proxies = []
