...
import requests
class GIthubiptotalFetcher(BaseFetcher):
    """
    https://github.com/iptotal/free-proxy-list
    """
    ...
    def fetch(self):
        ...
        urls = {
            "socks5": "https://raw.githubusercontent.com/iptotal/free-proxy-list/master/socks5.txt"
        }
        proxies = []
